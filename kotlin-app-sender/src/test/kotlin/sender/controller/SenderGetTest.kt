...
import sender.fixture.table.RecipientTableFixture
import sender.fixture.table.SenderTableFixture
import sender.fixture.table.buildRecipientOperation
...
class SenderGetTest {
    ...
    @Test
    fun `受領者一覧の取得`(): Unit = withTestApplication({ module(true, settings) }) {
